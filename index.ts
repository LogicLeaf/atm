...
let pinRead:string=fs.readFileSync('atmPin.txt', 'utf8')
let atmPin=parseInt(pinRead, 10)
let balanceRead:string=fs.readFileSync('balance.txt', 'utf8')
...
let cashWithdrawl=async()=>{                                         //func for cashwithdrawl
...
let balanceIquirey=()=>{                                             //func for balance inquirey
    console.log('your current balance is', balance)
    
}

let pinChange=async()=>{                                              //func for pin change
